...
#     api_key = "pcsk_4pzsjc_8cVoQW7396rN8FEyk8wUVwMRPNaVaPXrTDCj1ysE5taA1oZtPXDBakAZtHJSST3"  # Replace with your actual PineconeAPI key
...
#     search_query(model,index,query)